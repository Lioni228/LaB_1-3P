...
1. Git clone ````https://github.com/Lioni228/LaB_1-3P.git````
...
Запустив приложение вам будут доступны три кноки: "Сделать фото", "Поделиться", "Позвонить в поддержку".
Нажав на кнопку "Сделать фото", откроется камера.
Нажав на кнопку "Поделиться", откроется окно с иконками мессенджеров чтобы поделиться сделанной фотографией 
Нажав на кнопку "Позвонить в поддержку", откроется прижение для набора номера. И там будет представлен номер поддержки.
